...
class RecipeMultipleListAdapter(private var itemList: ArrayList<MainListItem>): RecyclerView.Adapter<RecipeListViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecipeListViewHolder {
        val viewHolder: RecipeListViewHolder

        val view = LayoutInflater.from(parent.context).inflate(R.layout.recipe_multiple_item, parent, false)
